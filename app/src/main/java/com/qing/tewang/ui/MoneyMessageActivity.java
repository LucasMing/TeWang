...
public class MoneyMessageActivity extends BaseActivity {
    ...
    private void loadData() {
        ...
        APIWrapper.getMoneyMessage(page)
                .subscribe(new SimpleDialogObserver<CommonData<MessageList>>(getActivity()) {
                    ...
                    public void onNext(CommonData<MessageList> data) {
                        if (data.getErrno() == 0) {
                            ...
                            if (messages.getTotal() == mMessageAdapter.getCount()) {
    ...
    private class MessageAdapter extends MyBaseAdapter<MessageList.ListBean> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.item_money_message, parent, false);
            }
